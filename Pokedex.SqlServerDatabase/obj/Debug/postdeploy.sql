...
BEGIN
    ...
    IF OBJECT_PokemonId('tempdb.dbo.#dbo_SeedPokemon') IS NOT NULL DROP TABLE #dbo_SeedPokemon;
    ...
    (  
    VALUES
     (0, 'missingno', 33, 136, 0, 29, 'Keen Eye', 0, 'Kanto'),
     ...
     (23, 'Ekans', 35, 60, 44, 55, 'IntimPokemonIdate', 0, 'Kanto'),
     (24, 'Arbok', 60, 85, 69, 80, 'IntimPokemonIdate', 0, 'Kanto'),
     ...
     (58, 'Growlithe', 55, 70, 45, 60, 'IntimPokemonIdate', 0, 'Kanto'),
     (59, 'Arcanine', 90, 110, 80, 95, 'IntimPokemonIdate', 0, 'Kanto'),
     ...
     (83, 'Farfetchd', 52, 65, 55, 60, 'Keen Eye', 0, 'Kanto'),
     ...
     (122, 'MrMime', 40, 45, 65, 90, 'Soundproof', 0, 'Kanto'),
     ...
     (128, 'Tauros', 75, 100, 95, 110, 'IntimPokemonIdate', 0, 'Kanto'),
     (129, 'Magikarp', 20, 10, 55, 80, 'Swift Swim', 0, 'Kanto'),
     (130, 'Gyarados', 95, 125, 79, 81, 'IntimPokemonIdate', 0, 'Kanto'),
 ...
 ) AS v ( [PokemonId], [Name], [HP], [Attack], [Defense], [Speed], [Ability], [Legendary], [Region] );
    ...
    MERGE [dbo].[Pokemon] AS p
        ...
        WHEN NOT MATCHED BY TARGET THEN
            INSERT 
                ([PokemonId], [Name], [HP], [Attack], [Defense], [Speed], [Ability], [Legendary], [Region])
            VALUES 
                (s.[PokemonId], s.[Name], s.[HP], s.[Attack], s.[Defense], s.[Speed], s.[Ability], s.[Legendary], s.[Region])
        WHEN MATCHED THEN 
            UPDATE SET 
