...
BEGIN
    ...
    -- Insert the Pokémon data into the temporary table
   ...
   -- Merge the new data into the actual table
    WITH cte_data AS 
        (SELECT [ID], [Name], [HP], [Attack], [Defense], [Speed], [Ability], [Legendary], [Region]
