...
The column Name on table [dbo].[Pokemon] must be changed from NULL to NOT NULL. If the table contains data, the ALTER script may not work. To avoid this issue, you must add values to this column for all rows or mark it as allowing NULL values, or enable the generation of smart-defaults as a deployment option.
...
GO
ALTER TABLE [dbo].[Pokemon] DROP CONSTRAINT [DF__Pokemon__Legenda__03F0984C];


GO
PRINT N'Dropping Unique Constraint unnamed constraint on [dbo].[Pokemon]...';


GO
ALTER TABLE [dbo].[Pokemon] DROP CONSTRAINT [UQ__Pokemon__737584F65015A846];
...
GO
ALTER TABLE [dbo].[Pokemon] DROP CONSTRAINT [CK__Pokemon__Attack__04E4BC85];
...
GO
ALTER TABLE [dbo].[Pokemon] DROP CONSTRAINT [CK__Pokemon__Defense__05D8E0BE];
...
GO
ALTER TABLE [dbo].[Pokemon] DROP CONSTRAINT [CK__Pokemon__HP__06CD04F7];
...
GO
ALTER TABLE [dbo].[Pokemon] DROP CONSTRAINT [CK__Pokemon__Speed__07C12930];
...
GO
ALTER TABLE [dbo].[Pokemon] ALTER COLUMN [Ability] VARCHAR (50) NOT NULL;

ALTER TABLE [dbo].[Pokemon] ALTER COLUMN [Attack] INT NOT NULL;

ALTER TABLE [dbo].[Pokemon] ALTER COLUMN [Defense] INT NOT NULL;

ALTER TABLE [dbo].[Pokemon] ALTER COLUMN [HP] INT NOT NULL;

ALTER TABLE [dbo].[Pokemon] ALTER COLUMN [Legendary] BIT NOT NULL;

ALTER TABLE [dbo].[Pokemon] ALTER COLUMN [Name] VARCHAR (50) NOT NULL;

ALTER TABLE [dbo].[Pokemon] ALTER COLUMN [Region] VARCHAR (50) NOT NULL;

ALTER TABLE [dbo].[Pokemon] ALTER COLUMN [Speed] INT NOT NULL;


GO
PRINT N'Creating Unique Constraint unnamed constraint on [dbo].[Pokemon]...';
...
GO
PRINT N'Creating Default Constraint unnamed constraint on [dbo].[Pokemon]...';


GO
ALTER TABLE [dbo].[Pokemon]
    ADD DEFAULT 0 FOR [Legendary];
...
BEGIN
    ...
    VALUES
     ...
     (152, 'Chikorita', 45, 49, 65, 45, 'Overgrow', 0, 'Johto'),
     (153, 'Bayleef', 60, 62, 80, 60, 'Overgrow', 0, 'Johto'),
     (154, 'Meganium', 80, 82, 100, 80, 'Overgrow', 0, 'Johto'),
     (155, 'Cyndaquil', 39, 52, 43, 65, 'Blaze', 0, 'Johto'),
     (156, 'Quilava', 58, 64, 58, 80, 'Blaze', 0, 'Johto'),
     (157, 'Typhlosion', 78, 84, 78, 100, 'Blaze', 0, 'Johto'),
     (158, 'Totodile', 50, 65, 64, 43, 'Torrent', 0, 'Johto'),
     (159, 'Croconaw', 65, 80, 80, 58, 'Torrent', 0, 'Johto'),
     (160, 'Feraligatr', 85, 105, 100, 78, 'Torrent', 0, 'Johto'),
     (161, 'Sentret', 35, 46, 34, 20, 'Run Away', 0, 'Johto'),
     (162, 'Furret', 85, 76, 64, 90, 'Run Away', 0, 'Johto'),
     (163, 'Hoothoot', 60, 30, 30, 50, 'Insomnia', 0, 'Johto'),
     (164, 'Noctowl', 100, 50, 50, 70, 'Insomnia', 0, 'Johto'),
     (165, 'Ledyba', 40, 20, 30, 55, 'Swarm', 0, 'Johto'),
     (166, 'Ledian', 55, 35, 50, 85, 'Swarm', 0, 'Johto')
...
DECLARE tableconstraintnames CURSOR LOCAL FORWARD_ONLY
    FOR SELECT SCHEMA_NAME([schema_id]),
               ...
               0
        FROM   [sys].[objects]
        WHERE  [parent_object_id] IN (OBJECT_ID(N'dbo.Pokemon'))
               AND [type] IN (N'F', N'C')
