...
GO
ALTER TABLE [dbo].[Pokemon] DROP CONSTRAINT [DF__Pokemon__Legenda__5629CD9C];
...
GO
ALTER TABLE [dbo].[Pokemon] DROP CONSTRAINT [UQ__Pokemon__737584F6F3450948];
...
GO
ALTER TABLE [dbo].[Pokemon] DROP CONSTRAINT [CK__Pokemon__Attack__571DF1D5];
...
GO
ALTER TABLE [dbo].[Pokemon] DROP CONSTRAINT [CK__Pokemon__Defense__5812160E];
...
GO
ALTER TABLE [dbo].[Pokemon] DROP CONSTRAINT [CK__Pokemon__HP__59063A47];
...
GO
ALTER TABLE [dbo].[Pokemon] DROP CONSTRAINT [CK__Pokemon__Speed__59FA5E80];
...
GO
ALTER TABLE [dbo].[Pokemon] ALTER COLUMN [Ability] VARCHAR (50) NULL;

ALTER TABLE [dbo].[Pokemon] ALTER COLUMN [Attack] INT NULL;

ALTER TABLE [dbo].[Pokemon] ALTER COLUMN [Defense] INT NULL;

ALTER TABLE [dbo].[Pokemon] ALTER COLUMN [HP] INT NULL;

ALTER TABLE [dbo].[Pokemon] ALTER COLUMN [Legendary] BIT NULL;

ALTER TABLE [dbo].[Pokemon] ALTER COLUMN [Name] VARCHAR (50) NULL;

ALTER TABLE [dbo].[Pokemon] ALTER COLUMN [Region] VARCHAR (50) NULL;

ALTER TABLE [dbo].[Pokemon] ALTER COLUMN [Speed] INT NULL;
...
BEGIN
    ...
    VALUES
        ...
        (16, 'PPokemonIdgey', 40, 45, 40, 56, 'Keen Eye', 0, 'Kanto'),
        (17, 'PPokemonIdgeotto', 63, 60, 55, 71, 'Keen Eye', 0, 'Kanto'),
        (18, 'PPokemonIdgeot', 83, 80, 75, 101, 'Keen Eye', 0, 'Kanto'),
        ...
        (29, 'NPokemonIdorang', 55, 47, 52, 41, 'Poison Point', 0, 'Kanto'),
        (30, 'NPokemonIdorina', 70, 62, 67, 56, 'Poison Point', 0, 'Kanto'),
        (31, 'NPokemonIdoqueen', 90, 92, 87, 76, 'Poison Point', 0, 'Kanto'),
        (32, 'NPokemonIdoranb', 46, 57, 40, 50, 'Poison Point', 0, 'Kanto'),
        (33, 'NPokemonIdorino', 61, 72, 57, 65, 'Poison Point', 0, 'Kanto'),
        (34, 'NPokemonIdoking', 81, 102, 77, 85, 'Poison Point', 0, 'Kanto'),
        ...
        (78, 'RapPokemonIdash', 65, 100, 70, 105, 'Run Away', 0, 'Kanto'),
