...
BEGIN
    ...
    SELECT 
        [Id], [Name], [HP], [Attack], [Defense], [Speed], [Ability], [Legendary], [Region]
 ...
 ) AS v ( [Id], [Name], [HP], [Attack], [Defense], [Speed], [Ability], [Legendary], [Region] );
    ...
    MERGE [dbo].[Pokemon] AS p
        ...
        WHEN NOT MATCHED BY TARGET THEN
            INSERT 
                ([Id], [Name], [HP], [Attack], [Defense], [Speed], [Ability], [Legendary], [Region])
            VALUES 
                (s.[Id], s.[Name], s.[HP], s.[Attack], s.[Defense], s.[Speed], s.[Ability], s.[Legendary], s.[Region])
        WHEN MATCHED THEN 
            UPDATE SET 
                [Name] = s.[Name], 
                [HP] = s.[HP], 
